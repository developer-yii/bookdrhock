...
@section('content')
    ...
    <section class="content">
        <div class="container my-5">
            <p>Last updated: December 02, 2022</p>
            ...
            <p>* Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FANDOMZ.</p>
            <p>* Cookies are small files that are placed on Your computer, mobile device or any other device by a website,
            ...
            <p>* Service Provider means any natural or legal person who processes the data on behalf of the Company. It
            ...
            <p>* Third-party Social Media Service refers to any website or any social
            ...
            <p>* Website refers to FANDOMZ, accessible from <<a href="https://fandomz.org">https: //fandomz.org</a>></p>
            ...
            <p>* Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can instruct Your browser
                ...
                will refuse Cookies, our Service may use Cookies.</p>

            <p>* Web Beacons. Certain sections of our Service and our emails may contain small electronic files known as web
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
                ...
                Learn more about cookies on the</p>
            ...
            <p>Purpose: These Cookies are essential to provide You with services
                ...
                features. They help to authenticate users and prevent fraudulent use of user accounts. Without these
            ...
            <p>* To manage Your Account: to manage Your registration as a user of the Service. The Personal Data You provide
                can give You access to different functionalities of the Service that are available to You as a registered
                user.</p>

            <p>* For the performance of a contract: the development, compliance and undertaking of the purchase contract for
                the products, items or services You have purchased or of any other contract with Us through the Service.</p>

            <p>* To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic
            ...
            <p>* To provide You with news, special offers and general information about other goods, services and events
            ...
            <p>* For business transfers: We may use Your information to evaluate or conduct a merger, divestiture,
                ...
                by Us about our Service users is among the assets transferred.</p>

            <p>* For other purposes : We may use Your information for other purposes, such as data analysis, identifying
            ...
            <p>* For business transfers: We may share or transfer Your personal information in connection with, or during
            ...
            <p>* With Affiliates: We may share Your information with Our affiliates, in which case we will require those
                affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries,
                joint venture partners or other companies that We control or that are under common control with Us.</p>
            ...
            <p>* With other users: when You share personal information or otherwise interact in the public areas with other
                ...
                users will be able to view descriptions of Your activity, communicate with You and view Your profile.</p>
            ...
            <p>* By email: <a href="mailto:admin@fandomz.org">admin@fandomz.org</a></p>
        </div>
    </section>
@endsection
