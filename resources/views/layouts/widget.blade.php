...
<script type="text/javascript">
    ...
    var hcaptcha_key = "<?= env('HCAPTCHA_SITEKEY') != '' ? env('HCAPTCHA_SITEKEY') : '' ?>";
    var recaptcha_1 = "";
    var hrecaptcha_1 = "";
    ...
    function onloadCallbackH() {
        if ($('#h-captcha').length) {
            var hrecaptcha_1 = hcaptcha.render('h-captcha', {
...
<script>
    jQuery(document).ready(function() {
        if ($('#g-recaptcha').length) {
            ...
            oScriptElem.src = 'https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit';
            document.head.appendChild(oScriptElem, document.head.getElementsByTagName("script")[0]);
        }
        if ($('#h-captcha').length) {
            var oScriptElem = document.createElement("script");
            oScriptElem.type = "text/javascript";
            oScriptElem.src = 'https://js.hcaptcha.com/1/api.js?onload=onloadCallbackH&render=explicit';
            document.head.appendChild(oScriptElem, document.head.getElementsByTagName("script")[0]);
        }
    });
</script>
